...
class MatchingResult{
  ...
  isDefault(){ return this.type === MATCH_TYPE.DEFAULT; }
  isStrict(){ return this.type === MATCH_TYPE.STRICT; }
  isNo(){ return this.type === MATCH_TYPE.NO; }
  isSubset(){ return this.type === MATCH_TYPE.SUBSET; }
